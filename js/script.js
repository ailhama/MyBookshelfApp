document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadBooks() {
      const unfinishedBooksContainer = document.getElementById("belumselesai");
      const finishedBooksContainer = document.getElementById("selesai");
    ...
    <span>(Penulis: ${book.author}), Tahun Terbit: ${book.year}
  `;
  //     bookElement.innerHTML = `
  //   <strong>${book.title}</strong><br>
